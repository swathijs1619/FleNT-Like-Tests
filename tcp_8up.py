...
# But the NO_TCP_FLOWS is set to `8` denoting there is going to be 8 tcp flows from the leftnodes to the corresponding rightnodes,
# which is in accordance with its experiment name "tcp_8up". 
...
# to emulate the "TCP upload" scenario with `8` tcp flow.
