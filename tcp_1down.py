...
# But the NO_TCP_FLOWS is set to `1` denoting there is going to be one tcp flow from the rightnode to the leftnode,
# which is in accordance with its experiment name "tcp_1down". 
...
# to emulate the "TCP download" scenario with `1` tcp flow.
