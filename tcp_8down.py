...
# But the NO_TCP_FLOWS is set to `8` denoting there is going to be 8 tcp flows from the rightnodes to the corresponding leftnodes,
# which is in accordance with its experiment name "tcp_8down". 
...
# to emulate the "TCP download" scenario with `8` tcp flows.
