...
# But the NO_TCP_FLOWS is set to `6` denoting there is going to be six tcp flows from the rightnodes to the corresponding leftnodes,
# which is in accordance with its experiment name "tcp_6down". 
...
# to emulate the "TCP download" scenario with `6` tcp flows.
