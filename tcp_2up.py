...
# But the NO_TCP_FLOWS is set to `2` denoting there is going to be two tcp flows from the leftnodes to the corresponding rightnodes,
# which is in accordance with its experiment name "tcp_2up". 
...
# to emulate the "TCP upload" scenario with `2` tcp flows.
