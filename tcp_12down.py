...
# But the NO_TCP_FLOWS is set to `12` denoting there is going to be 12 tcp flows from the rightnodes to the corresponding leftnodes,
# which is in accordance with its experiment name "tcp_12down". 
...
# to emulate the "TCP download" scenario with `12` tcp flows.
