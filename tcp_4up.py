...
# But the NO_TCP_FLOWS is set to `4` denoting there is going to be four tcp flows from the leftnodes to the corresponding rightnodes,
# which is in accordance with its experiment name "tcp_4up". 
...
# to emulate the "TCP upload" scenario with `4` tcp flows.
