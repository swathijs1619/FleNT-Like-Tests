...
# But the NO_TCP_FLOWS is set to `4` denoting there is going to be four tcp flows from the rightnodes to the corresponding leftnodes,
# which is in accordance with its experiment name "tcp_4down". 
...
# to emulate the "TCP download" scenario with `4` tcp flows.
